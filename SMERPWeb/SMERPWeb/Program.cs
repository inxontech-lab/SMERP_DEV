...
AddSaasClient<IInvItemCategoryApiClient, InvItemCategoryApiClient>();
builder.Services.AddScoped<IInvItemCategoryManagementService, InvItemCategoryManagementService>();
AddSaasClient<IInvItemSubCategoryApiClient, InvItemSubCategoryApiClient>();
builder.Services.AddScoped<IInvItemSubCategoryManagementService, InvItemSubCategoryManagementService>();
